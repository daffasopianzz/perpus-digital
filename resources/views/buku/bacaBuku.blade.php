...
@section('content')
                    ...
                    <div class="pdf-viewer text-center" id="pdf-viewer">
                        <script>
                            ...
                            pdfjsLib.getDocument(pdfUrl).promise.then(function(pdf) {
                                ...
                                // Membuat fungsi untuk merender setengah halaman
                                function renderPages(startPage, endPage) {
                                    if (startPage <= endPage) {
                                        pdf.getPage(startPage).then(function(page) {
                                            ...
                                            page.render(renderContext).promise.then(function() {
                                                ...
                                                renderPages(startPage + 2, endPage); // Loncat 2 halaman ke depan
                                            });
                                        });
                                    }
                                }

                                // Memulai proses rendering dengan setengah halaman pertama
                                renderPages(1, Math.ceil(numPages / 2));
                            });
                        </script>
                    </div>
                </div>
    ...
    <script>
        $(document).on('click', '#klik', function() {
            ...
            Swal.fire({
                title: "Kamu Belum Menjadi Member",
                text: "Daftar Terlebih Dahulu!",
                icon: "warning",
                showCancelButton: true,
                confirmButtonColor: "#3085d6",
                cancelButtonColor: "#d33",
                confirmButtonText: "Yes, Saya Mau!"
            }).then((result) => {
